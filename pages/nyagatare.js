  ...
  return (
    ...
    >
      <Head>
        ...
        <title>Scrapyard Nyagatare</title>
      </Head>
      <Flag />
      <Box
        sx={{
      ...
      >
        ...
        <Link
          ...
          href="https://forms.hackclub.com/scrapyard-signup?event=[nyagatare]"
          target="_blank"
        >
          <Box
            sx={{
      ...
      >
        ...
        >
          ...
          >
            {/* TODO: Change [EXAMPLECITY] to your event's city */}
            WHAT'S HAPPENING AT SCRAPYARD Nyagatare?
          </Heading>
        </Box>
        <Heading
          as="h2"
        ...
        >
          ...
          Scrapyard Nyagatare is a 12 hour event - HERE'S THE ROUGH
          SCHEDULE!
        </Heading>
        <Box
          sx={{
      ...
      >
          ...
          {Object.entries({
            ...
            'What if my parents are concerned?': (
              <>
                ...
                <Link href="mailto:nyagatare@scrapyard.hackclub.com">
                  {/* TODO: Change this email to your event's email */}
                  nyagatare@scrapyard.hackclub.com
                </Link>{' '}
                for questions.
              </>
            ),
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              SIGN UP FOR SCRAPYARD Nyagatare
            </Heading>
          </Box>
        </Link>
        <Heading
